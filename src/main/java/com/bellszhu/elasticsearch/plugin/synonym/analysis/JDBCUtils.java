...
public final class JDBCUtils {
    ...
    public static long queryMaxSynonymRuleVersion(String dbUrl) throws Exception {
        ...
        try {
            ...
            //conn = AccessController.doPrivileged((PrivilegedAction<Connection>) DriverManager.getConnection(dbUrl));
    ...
    public static void main(String[] args) throws Exception {
        String dbUrl = "jdbc:mysql://172.30.2.183:3306/gialen_product?user=dev&password=devtest&useUnicode=true&characterEncoding=UTF8";
        long version = JDBCUtils.queryMaxSynonymRuleVersion(dbUrl);
